...
contract ZKNOX_FalconTest is Test {
    ...
    function setUp() public {
        ...
        for (uint i = 0; i < 512; i++) assertEq(f_ntt_12289_512[i], g[i]);

        g = ntt.ZKNOX_NTTINV(f_ntt_mul_g_ntt_12289_512, ntt.o_psi_inv_rev());
        for (uint i = 0; i < 512; i++) assertEq(f_mul_g_12289_512[i], g[i]);
    ...
    function testVerify() public view {
        ...
        for (uint i = 0; i < 512; i++) {
            signature.s1[i] = uint256(tmps1[i]);
        }
        // forgefmt: disable-next-line
        uint[512] memory tmph = [
            uint(6018),
            3543,
            543,
            3451,
