...
#ifdef ALGNAME
    fn_req = "zknox_PQCsign_epervierKAT_" STR(ALGNAME) ".req";
#else
    sprintf(fn_req, "zknox_PQCsign_epervierKAT_%d.req", CRYPTO_SECRETKEYBYTES);
#endif
...
#ifdef ALGNAME
    fn_rsp = "zknox_PQCsign_epervierKAT_" STR(ALGNAME) ".rsp";
#else
    sprintf(fn_rsp, "zknox_PQCsign_epervierKAT_%d.rsp", CRYPTO_SECRETKEYBYTES);
#endif
